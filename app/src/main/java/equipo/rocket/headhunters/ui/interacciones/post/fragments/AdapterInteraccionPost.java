...
public class AdapterInteraccionPost extends RecyclerView.Adapter<AdapterInteraccionPost.InteraccionCardViewHolder> {
    ...
    public AdapterInteraccionPost(Fragment fragment){
    ...
    public InteraccionCardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.interaccion_post_layout,parent,false);
